...
class ProfilMahasiswaController extends Controller
{
    public function index()
    {
        ...
        $dokumenWajib = JenisDokumenModel::where('default', 1)->get();
        ...
        return view('profil.mahasiswa.index', compact('title', 'breadcrumb', 'data', 'dokumenWajib', 'dokumenTambahan'));
    }
    ...
    public function updateInformasiPengguna(Request $request)
    {
        try {
            ...
            if ($request->hasFile('foto_profil')) {
                ...
                $mahasiswa->user->path_foto_profil = 'users/foto_profil/' . $fileName;
                $mahasiswa->user->save();
            }
    ...
    public function tambahDokumen()
    {
        ...
        return view('profil.mahasiswa.form-dokumen', compact('title', 'dokumenTambahan'));
    }
    ...
    public function storeDokumen(Request $request)
    {
        ...
        return redirect()->route('mahasiswa.profil.index')->with('success', 'Dokumen berhasil diunggah');
    }
    ...
    public function editDokumen($id)
    {
        ...
        return view('profil.mahasiswa.form-dokumen', compact('title', 'dokumen', 'dokumenTambahan'));
    }
    ...
    public function updateDokumen(Request $request, $id)
    {
        ...
        return redirect()->route('mahasiswa.profil.index')->with('success', 'Dokumen berhasil diperbarui');
    }
}
